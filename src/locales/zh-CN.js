export default {
  ...
  "Organization": {
    ...
    "sync": "同步组织机构",
    "create_date": "创建时间",
    "code.required": "必须填写编码",
    "name.required": "必须填写名称",
    "short_name.required": "必须填写简称",
    "type.required": "必须填写组织机构类型",
    "status.required": "必须填写状态",
    "delete.confirm": "您是否确定要删除该组织机构？",
    "filter.query": "查询",
    "filter.input": "编码或名称或简称模糊查询",
    "operation": "操作"
  },
  "OrgStatus.Active": "激活",
  "OrgStatus.Locked": "锁定",
