export default {
  ...
  "Orgnization": {
    ...
    "address": "Address",
    "parent_id": "Parent id",
    "parent": "Parent Orgnization",
    "memo": "Memo",
    "status": "Status",
    "create_date": "Create Time",
    "create": "Create Orgnization",
    "update": "Update Orgnization",
    "sync": "Sync Orgnizations",
    "code.required": "code is required",
    "name.required": "name is required",
    "short_name.required": "short_name is required",
    "type.required": "org_type is required",
    "status.required": "status is required",
    "delete.confirm": "Are you sure delete this Orgnization?",
    "filter.query": "Search",
    "filter.input": "search like code or name",
    "operation": "Operation"
  },
  "OrgStatus.Active": "Active",
  "OrgStatus.Locked": "Locked",
